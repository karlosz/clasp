...
cleavir_file_list = [
    ...
    "src/lisp/kernel/contrib/sicl/Code/Cleavir/Dominance/packages",
    "src/lisp/kernel/contrib/sicl/Code/Cleavir/Dominance/dominance",
    ...
    "src/lisp/kernel/cleavir/ssa",
    "src/lisp/kernel/cleavir/ssa-copyprop",
